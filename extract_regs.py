...
codes = pd.read_csv(dir_atlas + '/' + 'ROIs_for_AF_comps.txt', header=None, names=['reg', 'regno'], sep=' ')
...
dir_top = '/mnt/DAT7/Z_TRACTOGRAMS_AF'
...
img_roi.to_filename( dir_sj + '/' + 'ROIs_AF.nii.gz' )
...
#%%
AF_lh = nib.streamlines.load(  dir_sj + '/' +  'tck_AF_all_Temp_Fr_Ins_LH' + '/' + 'tck_AF_all_Temp_Fr_Ins_LH_00.tck')

AF_rh = nib.streamlines.load(  dir_sj + '/' +  'tck_AF_all_Temp_Fr_Ins_RH' + '/' + 'tck_AF_all_Temp_Fr_Ins_RH_00.tck')


AF = AF_lh.tractogram + AF_rh.tractogram
...
nib.streamlines.save(tct_keep, 'tck_AF_filt.tck')
...
nib.streamlines.save(tct_keep, dir_sj + '/' + 'trk_AF_filt.trk', header=header)
...
tdi_img.to_filename(dir_sj + '/TDI_AF_1mm.nii.gz')
